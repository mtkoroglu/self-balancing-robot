...
/*
  Written by: Joop Brokking
  Modified by: M. Taha Koroglu
  -------------------------------- ROBOT KODU -----------------------------------------
*/
...
int acc_calibration_value = 0;                           //Enter the accelerometer calibration value -1049
...
/* variables associated with the remote controller (NRF24L01) */ 
...
void setup(){
  ...
  pinMode(10, OUTPUT);                                                      //Configure digital port 6 as output

  for(receive_counter = 0; receive_counter < 500; receive_counter++){       //Create 500 loops
    if(receive_counter % 15 == 0)digitalWrite(10, !digitalRead(10));        //Change the state of the LED every 15 loops to make the LED blink fast
...
//  }
  ...
  if(battery_voltage < 1050 && battery_voltage > 800){                      //If batteryvoltage is below 10.5V and higher than 8.0V
    digitalWrite(10, HIGH);                                                 //Turn on the led if battery voltage is to low
